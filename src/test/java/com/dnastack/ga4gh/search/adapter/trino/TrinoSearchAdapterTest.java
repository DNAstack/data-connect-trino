...
public class TrinoSearchAdapterTest {
    ...
    public void biFunctionPatternTest() {
        ...
        assertFalse(TrinoSearchAdapter.biFunctionPattern.matcher(jsonFunctionQuery).find());

        String ga4ghTypeFunctionQuery = "SELECT ga4gh_type(bogusfield, '$ref:http://path/to/whatever.com') FROM tableX";
        assertTrue(TrinoSearchAdapter.biFunctionPattern.matcher(ga4ghTypeFunctionQuery).find());
    }
