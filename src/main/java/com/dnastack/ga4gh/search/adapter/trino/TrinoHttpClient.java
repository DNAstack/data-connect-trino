...
import brave.Span;
import brave.Tracer;
import com.dnastack.ga4gh.search.adapter.trino.exception.TrinoIOException;
import com.dnastack.ga4gh.search.adapter.trino.exception.TrinoUnexpectedHttpResponseException;
    ...
    private SearchAuthRequest extractExtraCredentialsRequest(JsonNode node) {
        ...
        if (error != null &&
            ...
            try {
                ...
                return new SearchAuthRequest(key, resourceType, fromTrino);
            } catch (IOException e) {
