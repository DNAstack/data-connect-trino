...
public interface QueryJobDao {
    ...
    @SqlUpdate("INSERT INTO query_job (id, original_trace_id, query, schema, started_at, last_activity_at, next_page_url) VALUES (:id,:originalTraceId, :query, :schema, :startedAt, :lastActivityAt, :nextPageUrl)")
